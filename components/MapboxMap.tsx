...
export default function MapboxMap() {
  ...
  useEffect(() => {
    ...
    script.onload = () => {
      ...
      window.mapboxgl.accessToken = 'pk.eyJ1IjoiaHVnaHNpbHZhOTEiLCJhIjoiY21obTQ1azJhMjFkcTJycjRjZDU0ZGF2YyJ9.FsG9K_psV3D0INZBRYz0yg'
          ...
          offices.forEach(office => {
            ...
            const popup = new window.mapboxgl.Popup({ offset: 25 }).setHTML(`
              <div style="padding: 12px; min-width: 200px;">
                <h3 style="font-weight: bold; margin-bottom: 8px; color: #1e293b; font-size: 14px;">
                  ${office.name}
                </h3>
